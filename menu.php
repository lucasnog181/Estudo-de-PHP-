<nav class="modulos">
    <div class="modulo roxo">
        <h3>16. DATABASE PDO</h3>
        <ul>
            <li>
                <a href="exercicio.php?dir=DATABASE&file=connection">
                    Conexão PDO
                </a>
            </li>
            <li>
                <a href="exercicio.php?dir=DATABASE&file=insert_PDO">
                    Insert PDO
                </a>
            </li>
            <li>
                <a href="exercicio.php?dir=DATABASE&file=select_PDO">
                    Select PDO
                </a>
            </li>
        </ul>
    ...
    <div class="modulo verde">
        ...
        <ul>
            ...
            <li>
                <a href="exercicio.php?dir=DB&file=inserir_banco">
                    Inserir Registro
                </a>
            </li>
            <li>
                <a href="exercicio.php?dir=DB&file=select_banco">
                    Select Registro
                </a>
            </li>
            <li>
                <a href="exercicio.php?dir=DB&file=delete_table1">
                    Deletando Registro #1
                </a>
            </li>
            <li>
                <a href="exercicio.php?dir=DB&file=delete_table2">
                    Deletando Registro #2
                </a>
            </li>
            <li>
                <a href="exercicio.php?dir=DB&file=inserir_banco2">
                    Inserir Registro #2
                </a>
            </li>
            <li>
                <a href="exercicio.php?dir=DB&file=altera_table&codigo=1">
                    Alterar Table #2
                </a>
            </li>
        </ul>
